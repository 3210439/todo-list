...
import com.example.todolist.controller.api.TodoApiController
import com.example.todolist.model.http.ErrorResponse
...
class TodoApiControllerAdvice {
    ...
    fun methodArugmentNotValidException(e: MethodArgumentNotValidException, request: HttpServletRequest): ResponseEntity<ErrorResponse> {
        val errors = mutableListOf<com.example.todolist.model.http.Error>()

        e.bindingResult.allErrors.forEach{ errorObject ->
            val error = com.example.todolist.model.http.Error().apply {
